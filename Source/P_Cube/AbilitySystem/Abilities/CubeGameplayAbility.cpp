...
float UCubeGameplayAbility::GetManaCost(float InLevel) const
{
	float ManaCost = 0.f;
	if (const UGameplayEffect* CostEffect = GetCostGameplayEffect())
	{
		...
		{
			if (Mod.Attribute == UCubeAttributeSet::GetManaAttribute())
			{
...
float UCubeGameplayAbility::GetCooldown(float InLevel) const
{
	float Cooldown = 0.f;
